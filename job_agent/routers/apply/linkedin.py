...
async def _playwright_apply(job_id: str, req: LinkedInApplyRequest):
...
def _run_in_thread(job_id: str, req: LinkedInApplyRequest):
    """Run the Playwright session in a fresh thread with its own event loop."""
